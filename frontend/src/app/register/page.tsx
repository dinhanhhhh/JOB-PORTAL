      ...
      <Card className="w-full max-w-md rounded-2xl border p-8 shadow-lg backdrop-blur">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select id="role" className="h-9 w-full rounded-md border border-slate-700 bg-slate-900/40 px-3 text-sm" {...register("role")}>
          ...
          <Button
            ...
            variant="outline"
            className="w-full"
            onClick={() => (window.location.href = `${getApiBaseApi()}/auth/google`)}
          >
